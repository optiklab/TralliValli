...
public class AuthController : ControllerBase
{
    ...
    /// <summary>
    /// Generates a new invite token for inviting other users
    /// </summary>
    /// <param name="request">The invite generation request</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The generated invite token and link</returns>
    [HttpPost("invite")]
    [Authorize]
    ...
    public async Task<IActionResult> GenerateInvite(
        [FromBody] GenerateInviteRequest request,
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            // Build the full invite URL (frontend registration page with token)
            ...
            _logger.LogInformation("Invite generated by user {UserId}, expires in {Hours} hours", userId, request.ExpiryHours);
