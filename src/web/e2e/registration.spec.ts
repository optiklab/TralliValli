...
test.describe('Registration via Invite Link', () => {
  test('should successfully register a new user with valid invite link', async ({ page, testUser }) => {
    ...
    await page.fill('input[name="displayName"], input[placeholder*="name" i]', testUser.displayName);
