...
describe('KeyManagementService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should throw error when using service before initialization', async () => {
      ...
      await expect(
        newService.getAllConversationIds()
      ).rejects.toThrow('Key management service not initialized');
    });
    ...
    it('should throw error when accessing keys without master key', async () => {
      ...
      await expect(
        newService.storeConversationKey(testConversationId, key)
  ...
  describe('Master Key Management', () => {
    ...
    it('should derive same key with same password and salt', async () => {
      ...
      const result2 = await keyService.deriveMasterKeyFromPassword(testPassword, result1.salt, true);
    ...
    it('should reject short passwords', async () => {
      await expect(
        keyService.deriveMasterKeyFromPassword('short')
  ...
  describe('Conversation Key Derivation', () => {
    ...
    it('should reject empty conversation ID', async () => {
      ...
      await expect(
        keyService.deriveConversationKey(sharedSecret, '')
      ).rejects.toThrow('Conversation ID cannot be empty');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle decryption failure with wrong master key', async () => {
      ...
      await expect(
        keyService.getConversationKey(testConversationId)
      ).rejects.toThrow();
    });
